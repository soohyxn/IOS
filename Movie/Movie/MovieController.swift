...
class MovieController: UITableViewController {
    let movies = ["Chasing Amy", "Mallrats", "Dogma", "Clerks", "Jay & Silent Bob Strike Back", "Red State", "Cop Out", "Jersey Girl"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell { // IndexPath: cell들에 관한 정보
        ...
        // Configure the cell...
        cell.textLabel?.text = movies[indexPath.row] // indexPath.row - 몇 번째 cell인지
